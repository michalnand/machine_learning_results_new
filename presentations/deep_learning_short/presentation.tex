...
\begin{frame}{\bf FRI deep learning projects}

  \begin{itemize}
    \item machine learning summer school \\ \url{https://mlss.sk}
    \item masters projects
        \begin{itemize}
            \item Ing. Peter Tarábek, PhD. - Inteligentná analýza obrazku, Tvorba UI pre počítačové hry
            \item doc. Mgr. Ondrej Šuch, PhD. - Aplikácie strojového učenia pre Big Data
        \end{itemize}
    \item AI seminars - monday, prof. Ing. Martin Klimo, PhD.
    \item robotics competition
        \begin{itemize}
            \item Istrobot \url{www.robotika.sk}
            \item Robotický den \url{robotickyden.cz}
        \end{itemize}
    \item Learning systems - methods and applications\\ Ing. Michal Chovanec, PhD., 5II140, AMUS
  \end{itemize}
\end{frame}
