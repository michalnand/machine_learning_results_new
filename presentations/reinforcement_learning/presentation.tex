...
\begin{columns}
  ...
  \begin{column}{0.5\textwidth}  %%<--- here
      ...
      \begin{align*}
        \Delta Q'(s_0, a_0) &= \alpha\Big(R(s_0, a_0) + \gamma Q'(s_1, a_1)\Big) \\
        \Delta Q'(s_1, a_1) &= \alpha\Big(R(s_1, a_1) + \gamma Q'(s_2, a_2)\Big) \\
        \Delta Q'(s_2, a_2) &= \alpha\Big(R(s_2, a_2) + \gamma Q'(s_3, a_3)\Big) \\
        ... \\
        \Delta Q'(s_{n}, a_{n}) &= \alpha\Big(R(s_{n}, a_{n}) + \gamma Q'(s_{n+1}, a_{n+1})\Big)
      \end{align*}
...
\begin{enumerate}
\item computer temporary $Q_t$ batch
      \begin{align*}
...
\begin{column}{0.5\textwidth}
  ...
  \begin{figure}
    \includegraphics[scale=0.22]{../../pictures/catcher.png}
  \end{figure}
